...
local Window = Fluent:CreateWindow({Title = "DogHub",SubTitle = "| By:Dog",TabWidth = 180,Size = UDim2.fromOffset(660, 440),Acrylic = false,Theme = "Rose",MinimizeKey = Enum.KeyCode.End})
